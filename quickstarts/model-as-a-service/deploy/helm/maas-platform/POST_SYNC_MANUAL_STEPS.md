...
**Ref:** [`maas-1.md`](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/deploy/infoDocs/maas-1.md) §1.2 dashboard configuration
...
[`maas-1.md`](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/deploy/infoDocs/maas-1.md) are complete, including OpenShift AI
...
- [`VERIFICATION.md`](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/deploy/helm/maas-platform/VERIFICATION.md) — full deployment verification checklist (maas-1.md §1.5)
- [`DEPLOYMENT_ORDER.md`](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/deploy/helm/maas-platform/DEPLOYMENT_ORDER.md) — ArgoCD Application wave order and sync strategy
- [`MAAS_PLATFORM_CUSTOMIZATION_GUIDE.md`](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/deploy/helm/maas-platform/MAAS_PLATFORM_CUSTOMIZATION_GUIDE.md) — all `maas-platform` Helm values explained
