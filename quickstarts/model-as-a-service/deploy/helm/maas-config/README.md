...
helm template maas-config \
  quickstarts/model-as-a-service/deploy/helm/maas-config \
  -f quickstarts/model-as-a-service/deploy/helm/maas-config/values.yaml \
  -f quickstarts/model-as-a-service/deploy/helm/maas-config/environments/prod/values-prod.yaml
```
...
helm template maas-config \
  quickstarts/model-as-a-service/deploy/helm/maas-config \
  -f quickstarts/model-as-a-service/deploy/helm/maas-config/values.yaml \
  -f quickstarts/model-as-a-service/deploy/helm/maas-config/environments/dev/values.yaml
```
