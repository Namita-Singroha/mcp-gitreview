...
```text
quickstarts/model-as-a-service/deploy/helm/maas-model-deploy/
├── Chart.yaml
├── README.md
...
> **Full walkthrough:** See [VAULT-SECRET-SETUP.md](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/deploy/helm/maas-model-deploy/VAULT-SECRET-SETUP.md).
...
3. Vault path populated **before** the first ArgoCD sync — see [VAULT-SECRET-SETUP.md](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/deploy/helm/maas-model-deploy/VAULT-SECRET-SETUP.md).
...
helm template fusion-maas-model-deploy-prod-tiny-llama \
  quickstarts/model-as-a-service/deploy/helm/maas-model-deploy \
  --namespace deploy-models \
  -f quickstarts/model-as-a-service/deploy/helm/maas-model-deploy/values.yaml \
  -f quickstarts/model-as-a-service/deploy/helm/maas-model-deploy/environments/prod/values-tiny-llama.yaml \
  --set s3.accessKeyId=<key> \
  --set s3.secretAccessKey=<secret>
```
...
helm template fusion-maas-model-deploy-prod-gpt-oss-20b \
  ...
  --namespace deploy-models \
  -f quickstarts/model-as-a-service/deploy/helm/maas-model-deploy/values.yaml \
  -f quickstarts/model-as-a-service/deploy/helm/maas-model-deploy/environments/prod/values-gpt-oss-20b.yaml \
  --set s3.accessKeyId=<key> \
  --set s3.secretAccessKey=<secret>
```
...
- [`VAULT-SECRET-SETUP.md`](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/deploy/helm/maas-model-deploy/VAULT-SECRET-SETUP.md) — step-by-step Vault and ESO setup guide for this chart
- [`VAULT-SECRET-SETUP.md`](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/deploy/helm/maas-model-registry/VAULT-SECRET-SETUP.md) — equivalent guide for `maas-model-registry` (Git credentials + Hugging Face token)
- [`VAULT-SECRET-SETUP.md`](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/deploy/helm/maas-platform/VAULT-SECRET-SETUP.md) — equivalent guide for `maas-platform` (Postgres + DB config)
- [`docs/deploying-external-secrets-guide.md`](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/fusion-gitops/docs/deploying-external-secrets-guide.md) — ESO operator installation
- [`docs/deploying-vault-guide.md`](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/fusion-gitops/docs/deploying-vault-guide.md) — Vault operator installation
- [`environments/CHANGELOG.md`](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/deploy/helm/maas-model-deploy/environments/CHANGELOG.md) — add/remove model procedures and version history
