...
source:
  ...
  path: quickstarts/model-as-a-service/deploy/helm/maas-config
```
...
```bash
git add quickstarts/model-as-a-service/deploy/helm/maas-config/environments/prod/values-prod.yaml
...
| Helm chart README | [`../../helm/maas-config/README.md`](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/deploy/helm/maas-config/README.md) |
| Values file changelog | [`../../helm/maas-config/environments/CHANGELOG.md`](https://github.ibm.com/ProjectAbell/Fusion-AI/blob/main/quickstarts/model-as-a-service/deploy/helm/maas-config/environments/CHANGELOG.md) |
